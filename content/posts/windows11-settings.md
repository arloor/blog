...
# 为每个键设置别名或执行相应的命令
$ShortNameSimple.Keys | ForEach-Object {
    # 对其他命令设置别名
    Set-Alias $_ $ShortNameSimple.$_
}
...
function Watch-ProxyLog {
    Get-Content -Tail 50 -Wait C:\tmp\proxy.log_rCURRENT
}
...
或者执行使用 windows powershell 1.0 的配置文件:
