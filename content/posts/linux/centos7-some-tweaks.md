...
很稳也很慢。稳：三网双程都是cn2 gia，延迟都是145ms左右，而且不会跳；慢：服务器上传下载都慢。这个IP段不知道为啥我用着十分慢。后面开始折腾，从dc9迁到dc8,再从dc8迁回dc9，ip变成了另一个段。后面会展示测速结果，显示比这个ip的速度好很多

## 搬瓦工dc8 cn2机房(95.169.17.xx)
