...
如果试用了感觉还满意，就可以开始看下面的教程啦。PS:如果觉得部署安装挺麻烦的(或者买VPS搭梯子要么慢要么贵)，可以付费使用我自己用的节点（当然不是5M了），价格十分便宜。。有这个意愿的小伙伴也可以进[电报群](https://t.me/arloorproxy)交流，同样可以发送邮件到admin@arloor.com
